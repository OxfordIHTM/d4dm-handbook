...
Step 3: In the menu bar, select Format --> Cells -- >Choose “Text” on the left (see @fig-date-format-text-03).
...
![Enter an apostrophe followed by YYYY-MM-DD date format](images/date_format_text_05.png){#fig-date_format_text_05 fig-align="center" width="70%"}
...
![Date value as text in YYYYMMDD format](images/date_format_text_09.png){#fig-date-format-text-09 fig-align="center" width="70%"}
